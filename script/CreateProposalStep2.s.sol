...
contract CreateProposalStep2 is Script {
    ...
    function run() external {
        ...
        uint256 pid1 = gov.propose(targets1, values1, calldatas1, "PIP-01: Increase LTV cap for ETH collateral to 80%");
        ...
        uint256 pid2 =
            gov.propose(targets2, values2, calldatas2, "PIP-02: Integrate Chainlink oracle for Arbitrum Sepolia");
